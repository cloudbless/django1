...
# 加载本地 .env 文件（仅本地生效，服务器 Docker 不会加载）
load_dotenv()
...
DATABASES = {
    'default': {
        ...
        'NAME': 'django1',           # 匹配你刚才执行的 CREATE DATABASE django1;
        'USER': 'root',               # 匹配你登录成功的 root 用户
        'PASSWORD': '123456',         # 匹配你刚才改成功的密码
        'HOST': '127.0.0.1',
        'PORT': '3306',
        'OPTIONS': {
            'charset': 'utf8mb4',
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),  # 只保留这一行，删除所有 APP 对应的 static 路径
]
